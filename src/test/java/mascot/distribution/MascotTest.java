...
public class MascotTest  {
	...
	public void testMascotStructured(){
		...
		RealVectorParam<Real> Ne = new RealVectorParam<>(new double[]{1, 2}, Real.INSTANCE);
		RealVectorParam<Real> backwardsMigration = new RealVectorParam<>(new double[]{0.3, 2}, Real.INSTANCE);
		int dim = 2;
	...
	public void testMascotUnstructured(){
		...
		// build constant dynamics
		RealVectorParam<Real> Ne = new RealVectorParam<>(new double[]{1.5, 2}, Real.INSTANCE);
		RealVectorParam<Real> backwardsMigration = new RealVectorParam<>(new double[]{0, 0}, Real.INSTANCE);
		int dim = 2;
		Constant constant = new Constant();
		constant.initByName("backwardsMigration", backwardsMigration, "Ne", Ne, "dimension", dim, "typeTrait", traitSet);
